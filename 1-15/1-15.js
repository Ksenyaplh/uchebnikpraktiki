...
let obj = {
    овен: {
        today: "С утра вы почувствуете прилив сил и энергии. Ваш энтузиазм окажется заразительным, поэтому вокруг вас возникнет позитивная атмосфера.",
        tomorrow: "У вас все получится, если вы сумеете не подцепить негативное настроение от коллег. Ваша энергичность позволит справиться и с профессиональными задачами, и с домашними проблемами. ",
        dayAfterTomorrow: "Близкие родственники могут попросить вас помочь в решении их проблем. Сделайте то, что в ваших силах, но не берите на себя слишком многое."
    },
    телец: {
        today: "С утра вы почувствуете прилив сил и энергии. Ваш энтузиазм окажется заразительным, поэтому вокруг вас возникнет позитивная атмосфера.",
        tomorrow: "У вас все получится, если вы сумеете не подцепить негативное настроение от коллег. Ваша энергичность позволит справиться и с профессиональными задачами, и с домашними проблемами. ",
...
/////////////////// 10 ///////////////////////
let arr = [
    {text: 'Скоро вы отправитесь в поездку.', color: 'green'},
    {text: 'Будут новое приятное знакомство.', color: 'green'},
    {text: 'Будь смелее в своем выборе. Мало знать себе цену — надо еще пользоваться спросом.', color: 'green'},
    {text: 'Сегодня не путай настроение с самочувствием.', color: 'green'},
    {text: 'Сегодня вас ждут неудачи', color: 'red'},
    {text: 'берегите свои вещи сегодня', color: 'red'},
    {text: 'сегодня все пойдет не по плану', color: 'red'}
];
